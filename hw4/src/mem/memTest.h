...
private:
   vector<MemTestObj*>   _objList;  // for cmd> mta 2 => 會new兩個MTO，傳回p1, p2，會依序存在此array裡
   // 若是cmd> mta 2 -arr 3 => new兩個MTO[3]

   vector<MemTestObj*>   _arrList;  // for cmd> mtd -index 1 => 要delete時不知道要刪誰，去index 1刪
};
